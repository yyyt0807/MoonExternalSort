...
- Add typed stable ordering for text and signed-integer keys.
- Add bounded Run construction, heap merge and merge-pass planning.
- Add bounded byte-oriented input line framing.
